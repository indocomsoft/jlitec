...
import jlitec.backend.c.Method;
import jlitec.backend.c.Program;
import jlitec.backend.c.Struct;
import jlitec.backend.c.Type;
import jlitec.backend.c.Var;
import jlitec.backend.c.expr.AddrExpr;
import jlitec.backend.c.expr.BinaryExpr;
import jlitec.backend.c.expr.BinaryOp;
import jlitec.backend.c.expr.BoolLiteralExpr;
import jlitec.backend.c.expr.CallExpr;
import jlitec.backend.c.expr.Expr;
import jlitec.backend.c.expr.FieldExpr;
import jlitec.backend.c.expr.IdExpr;
import jlitec.backend.c.expr.IntLiteralExpr;
import jlitec.backend.c.expr.NullExpr;
import jlitec.backend.c.expr.StringLiteralExpr;
import jlitec.backend.c.expr.UnaryExpr;
import jlitec.backend.c.expr.UnaryOp;
import jlitec.backend.c.stmt.CallStmt;
import jlitec.backend.c.stmt.FieldAssignStmt;
import jlitec.backend.c.stmt.GotoStmt;
import jlitec.backend.c.stmt.IfStmt;
import jlitec.backend.c.stmt.LabelStmt;
import jlitec.backend.c.stmt.ReturnStmt;
import jlitec.backend.c.stmt.Stmt;
import jlitec.backend.c.stmt.VarAssignStmt;
