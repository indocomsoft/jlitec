...
import jlitec.passes.Pass;

public class FlowPass implements Pass<jlitec.ir3.Program, Map<jlitec.ir3.Method, FlowGraph>> {
  @Override
  public Map<jlitec.ir3.Method, FlowGraph> pass(Program input) {
