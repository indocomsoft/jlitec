...
public class BinaryExprTest {
  ...
  public void testBooleanInputBooleanOutputAcceptable() {
    final List<Argument> list =
        List.of(
            ...
            new Argument(
                new ParenExpr(new IntLiteralExpr(5)),
                new IdExpr("a")), // type-erasure of parenthesis
            // Bool || Unknown
            ...
            new Argument(
                new BinaryExpr(BinaryOp.AND, new BoolLiteralExpr(true), new BoolLiteralExpr(false)),
  ...
  public void testBooleanInputBooleanOutputThrows() {
    ...
    for (final var arg : list) {
      assertThrows(
          IncompatibleTypeException.class, () -> new BinaryExpr(BinaryOp.OR, arg.lhs(), arg.rhs()));
      assertThrows(
          IncompatibleTypeException.class,
          () -> new BinaryExpr(BinaryOp.AND, arg.lhs(), arg.rhs()));
    }
  }
}
